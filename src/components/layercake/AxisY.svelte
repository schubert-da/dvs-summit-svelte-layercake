<!--
 ...
 <script>
  ...
  <g class='axis y-axis' transform='translate({-$padding.left}, 0)'>
    ...
    {/each}
    <line
        class="gridline divider-line--top"
        transform='translate(0, {$yScale(tickVals[0])})'
        x1='20px'
        x2='100%'
        y1={(isBandwidth ? ($yScale.bandwidth() / 2) : 5)}
        y2={(isBandwidth ? ($yScale.bandwidth() / 2) : 5)}
    ></line>
    <line
        class="gridline divider-line--bottom"
        transform='translate(0, {$yScale(tickVals[0])})'
        x1='20px'
        x2='100%'
        y1={(isBandwidth ? ($yScale.bandwidth() / 2) : 35)}
        y2={(isBandwidth ? ($yScale.bandwidth() / 2) : 35)}
    ></line>
  </g>
